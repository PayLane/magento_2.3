...
define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'PeP_PaymentGateway/payment/banktransfer',
            ...
            getPaymentTypes: function () {
                return [
                    ...
                    {value: 'MT', label: 'mBank (mTransfer)'},
                    {value: 'IN', label: 'Inteligo'},
                    {value: 'IP', label: 'PKO Bank Polski (iPKO)'},
                    {value: 'MI', label: 'Millenium Bank'},
                    ...
                    {value: 'WB', label: 'Santander'},
                    {value: 'PB', label: 'BNP PARIBAS'},
                    {value: 'CT', label: 'Citi Hanlowy'},
                    {value: 'PL', label: 'Plus Bank'},
                    {value: 'NP', label: 'Noble Pay'},
                    {value: 'BS', label: 'Bank Spółdzielczy'},
                    {value: 'NB', label: 'Nest Bank'},
